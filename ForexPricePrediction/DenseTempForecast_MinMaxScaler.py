# -*- coding: utf-8 -*-
"""
Created on Tue Jan  8 11:38:49 2019

@author: Tim George Kabue
@email: timkabue@yahoo.com
@phone_number: +254706762054
@title: Densely connected network for temperature forecast with MinMaxScaler
"""
...
train_gen = generator(data,lookback=lookback,delay=delay,min_index=0,max_index=200000,shuffle=False,step=step,batch_size=batch_size)
